class Controls {
    class BackgroundMessagesList: RscText {
        x = 0;
        y = 0;
        w = ADMINMENU_MSGS_W_LIST;
        h = ADMINMENU_MSGS_H_LIST;
        colorBackground[] = {0, 0, 0, 0.3};
        style = "0x02";
    };

    class ListMessages: RscListBox {
        idc = IDC_ADMINMENU_MSGS_LIST;
