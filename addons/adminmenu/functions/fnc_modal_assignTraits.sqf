...
_ctrlLabelTraits ctrlSetPosition [0, 0, (0.25 * _ctrlGrpWidth), OP183_ADMINMENU_STD_HEIGHT];
...
private _ctrlComboTraitY = 2.2 * OP183_ADMINMENU_STD_HEIGHT;
private _ctrlComboTraitW = 0.5 * _ctrlGrpWidth;
private _traitComboCtrls = [];

{
    private _ctrlLineY = _ctrlComboTraitY + _forEachIndex * (1.1 * OP183_ADMINMENU_STD_HEIGHT);
    ...
    _ctrlComboTraitLabel ctrlSetPosition [0.1 * OP183_ADMINMENU_STD_WIDTH, _ctrlLineY, _ctrlComboTraitLabelW, OP183_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlComboTrait ctrlSetPosition [_ctrlComboTraitX, _ctrlLineY, _ctrlComboTraitW, OP183_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    systemChat format ["[OP183 Admin Menu] Assigned traits to %1 player(s)", count GVAR(utilityData)];
