...
/* ----------------------------------------------------------------------------
Internal Function: OP183_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call OP183_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_OP183_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[OP183 Adminmenu] Printed entry: %1%2",
