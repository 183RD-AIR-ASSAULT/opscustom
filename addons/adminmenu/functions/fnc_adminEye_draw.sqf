...
// Wave Spawners
{
    ...
    _fullmapWindow drawIcon ["\z\op183\addons\common\images\op183_card_1024.paa",[0,0,0,0.5],_pos,20,20,0];
...
private _i = 1;
while {true} do {
    private _var = missionNamespace getVariable[format["op183_respawnPoint%1",_i],objNull];
