...
/* ----------------------------------------------------------------------------
Internal Function: OP183_adminmenu_fnc_messageLog_printAll
...
Examples:
    (begin example)
        [] call OP183_adminmenu_fnc_messageLog_printAll;
    (end)
...
diag_log "[OP183 Adminmenu] Printing complete log to RPT";
...
diag_log "[OP183 Adminmenu] Log end";
