 ...
 * \z\op183\addons\hints\functions\ace_common\fn_displayTextPicture.sqf
 * by Ojemineh
 *
...
private _hint_option_ace = (missionNamespace getVariable ["op183_hint_option_ace", true]);
...
if (_hint_enabled && _hint_option_ace) then {
 ...
 _text = format [hint_op183_image_3, _image, _imageColor call BIS_fnc_colorRGBtoHTML, _text];

 [_text] call op183_fnc_hint;
