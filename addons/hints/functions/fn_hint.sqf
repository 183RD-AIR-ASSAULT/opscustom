 ...
 * \z\op183\addons\hints\functions\fn_hint.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [ format [hint_op183_default, "Hello World"] ] call op183_fnc_hint;
 *
 */
...
[_text, _color, _sound, _delay, _position] spawn {
    ...
    private _hint_enabled  = (missionNamespace getVariable ["op183_hint_enabled", true]);
    private _hint_position  = (missionNamespace getVariable ["op183_hint_position", 0]);
    private _hint_duration  = (missionNamespace getVariable ["op183_hint_duration", 15]);
    private _hint_sound   = (missionNamespace getVariable ["op183_hint_sound", 1]);
    private _hint_color_bg  = (missionNamespace getVariable ["op183_hint_color_background", [0.000,0.000,0.000,0.5]]);
    private _hint_color_0  = (missionNamespace getVariable ["op183_hint_color_default", [0.000,0.824,0.000,1]]);
    private _hint_color_1  = (missionNamespace getVariable ["op183_hint_color_info", [0.824,0.824,0.000,1]]);
    private _hint_color_2  = (missionNamespace getVariable ["op183_hint_color_alert", [0.824,0.000,0.000,1]]);
    private _hint_queue_size = (missionNamespace getVariable ["op183_hint_queue_size", 3]);
    private _hint_queue_alpha = (missionNamespace getVariable ["op183_hint_queue_alpha", 0.4]);
    ...
    _display = uiNamespace getVariable "op183_ctrlHint";
    ...
    switch (_position) do {
        case 1: {
            ...
            _scrollDown = true;
            _barLeft = true;
            _queue = uiNamespace getVariable ["op183_hint_queue_1", []];
        };
        case 2: {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = false;
            _barLeft = true;
            _queue = uiNamespace getVariable ["op183_hint_queue_2", []];
        };
        case 3: {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = false;
            _barLeft = false;
            _queue = uiNamespace getVariable ["op183_hint_queue_3", []];
        };
        default {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = true;
            _barLeft = false;
            _queue = uiNamespace getVariable ["op183_hint_queue_0", []];
        };
    };
    ...
    switch (_sound) do {
        ...
        case 4: { playSound ["op183ticalPing4", true]; };
        default {};
    };
    ...
    switch (_position) do {
        case 0: { uiNamespace setVariable ["op183_hint_queue_0", _queue]; };
        case 1: { uiNamespace setVariable ["op183_hint_queue_1", _queue]; };
        case 2: { uiNamespace setVariable ["op183_hint_queue_2", _queue]; };
        case 3: { uiNamespace setVariable ["op183_hint_queue_3", _queue]; };
    };
