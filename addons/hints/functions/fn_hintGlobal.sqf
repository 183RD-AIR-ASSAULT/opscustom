 ...
 * \z\op183\addons\hints\functions\fn_hintGlobal.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [ format [hint_op183_default, "Hello World"] ] call op183_fnc_hintGlobal;
 *
 */
...
[_text, _color, _sound, _delay, _position] remoteExecCall ["op183_fnc_hint", 0];
