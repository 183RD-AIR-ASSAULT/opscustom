    ...
    class CAManBase: Man {
        ...
        class ACE_SelfActions {
                class GVAR(Medical_Supplies_Action_FirstAid) {
                    ...
                    condition = "[_player] call op183_medbags_fnc_canUnpackFirstAid";
                    statement = "[_player] call op183_medbags_fnc_doUnpackFirstAid";
                ...
                class GVAR(Medical_Supplies_Action_MedicKit) {
                    ...
                    condition = "[_player] call op183_medbags_fnc_canUnpackMedicKit";
                    statement = "[_player] call op183_medbags_fnc_doUnpackMedicKit";
                    exceptions[] = {"isNotInside", "isNotSitting"};
                    icon = QPATHTOF(data\icons\medical_cross_ex_ca.paa);
                    showDisabled = 0;
                };
                ...
                class GVAR(Medical_Supplies_Action_Trauma) {
                    ...
                    condition = "[_player] call op183_medbags_fnc_canUnpackTrauma";
                    statement = "[_player] call op183_medbags_fnc_doUnpackTrauma";
                    exceptions[] = {"isNotInside", "isNotSitting"};
                    icon = QPATHTOF(data\icons\medical_cross_ex_ca.paa);
                    showDisabled = 0;
                };
                ...
                class GVAR(Medical_Supplies_Action_DrugKit) {
                    ...
                    condition = "[_player] call op183_medbags_fnc_canUnpackDrugKit";
                    statement = "[_player] call op183_medbags_fnc_doUnpackDrugKit";
                    exceptions[] = {"isNotInside", "isNotSitting"};
                    icon = QPATHTOF(data\icons\medical_cross_ex_ca.paa);
                    showDisabled = 0;
                };
        ...
        //         condition = "[_player] call op183_medbags_fnc_canTake";
        //         statement = "[(_player, _target)] call op183_medbags_fnc_doTake";
        //         exceptions[] = {"isNotInside", "isNotSitting"};
        //         icon = QPATHTOF(data\icons\medical_cross_ex_ca.paa);
        //         showDisabled = 0;
        //     };
