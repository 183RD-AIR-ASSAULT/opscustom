...
class cfgScriptPaths {
    OP183_briefing = "z\op183\addons\briefing\ui_scripts\";
};
*/
...
class Cfg3DEN {
    class Mission {
        class GVAR(Attributes) {
            displayName = "OP183 Autotest"; // Text visible in the window title as "Edit <displayName>"
            ...
            class AttributeCategories {
                class GVAR(FakeSettings) {
                    displayName = "OP183: Autotest settings"; // Category name visible in Edit Attributes window
