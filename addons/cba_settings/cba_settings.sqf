...
FORCE FORCE op183_bft_friendlySides_RESISTANCE = [1,3];
FORCE FORCE op183_bft_friendlySides_WEST = [2];
FORCE FORCE op183_bft_friendlySidesDynamic = true;
FORCE FORCE op183_bft_groupIconsInteraction = "hover";
FORCE FORCE op183_bft_medicalSystem = "ACE";
FORCE FORCE op183_bft_requireItemGPS = true;
FORCE FORCE op183_bft_showAIGroups = true;
FORCE FORCE op183_bft_showAINames = true;
FORCE FORCE op183_bft_showCivilians = false;
FORCE FORCE op183_bft_showGroupIcons = true;
FORCE FORCE op183_bft_showGroupText = true;
FORCE FORCE op183_bft_showLifeState = true;
FORCE FORCE op183_bft_showOwnFactionOnly = false;
FORCE FORCE op183_bft_showOwnGroup = true;
FORCE FORCE op183_bft_showOwnGroupUnits = true;
FORCE FORCE op183_bft_showPlayerNames = true;
FORCE FORCE op183_bft_showUnitNames = true;
...
force op183_Channels_DirectDuration = 0;
force op183_Channels_DirectText = true;
force op183_Channels_DirectVoice = false;
force op183_Channels_GlobalDuration = 0;
force op183_Channels_GlobalText = false;
force op183_Channels_GlobalVoice = false;
force op183_Channels_GroupDuration = 0;
force op183_Channels_GroupText = false;
force op183_Channels_GroupVoice = false;
force op183_Channels_SideDuration = 0;
force op183_Channels_SideText = false;
force op183_Channels_SideVoice = false;
force op183_Channels_VehicleDuration = 0;
...
force op183_spectator_civilianSide = false;
force op183_spectator_civilianSideUnconscious = false;
force op183_spectator_enabled = false;
force op183_spectator_freeCamera = false;
force op183_spectator_freeCameraUnconscious = false;
force op183_spectator_sides = 1;
force op183_spectator_sidesUnconscious = 1;
force op183_spectator_TPPCamera = false;
...
force op183_suppress_overlayTexture = 0;
