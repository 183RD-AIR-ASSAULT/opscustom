            ...
            class PREFIX {
                ...
                class Attributes {
                    class GVAR(Arsenal_Select) {
                        property = QUOTE(OP183_Arsenal_Select);
                        ...
                        expression = "if (_value > -1) then {[_this, _value] call OP183_fnc_FullArsenal;}";
                        typeName = "STRING";
                        condition = "objectHasInventoryCargo - objectVehicle";
                        defaultValue = "-1";
                    };
                        class GVAR(Ammo_Select) {
                        property = QUOTE(OP183_Ammo_Select);
                        control = "ArsenalSelect";
                        ...
                        expression = "if (_value > -1) then {[_this, _value] call OP183_fnc_LimitedArsenal;}";
                        typeName = "STRING";
                        condition = "objectHasInventoryCargo - objectVehicle";
                        defaultValue = "-1";
                    };
                        class GVAR(LimitedAmmoSelect) {
                        property = QUOTE(OP183_LimitedAmmoSelect);
                        ...
                        property = QUOTE(OP183_Equipment_Select);
