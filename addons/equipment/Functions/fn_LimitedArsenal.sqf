/*
Function: OP183_fnc_LimitedArsenal
...
Description:
    ...
    OP183_fnc_Arsenal, only the items in the container change.
    ...
    Examples:
    (begin example)
    [this] call OP183_fnc_LimitedArsenal;
    [this, "Aegis", 50] call OP183_fnc_LimitedArsenal;
    [this, "VANILLA"] call OP183_fnc_LimitedArsenal;
    [MyAmmoCrate, "RHS", 0] call OP183_fnc_LimitedArsenal;
    (end)
...
call {
    if (_Type isEqualto 0) exitwith {_Type = "OP183"};
...
private [
    ...
    call {
    if (_Type isEqualTo "OP183") exitwith {
    _AvailableItems =[];
            _AvailableHeadgear = [];
            _AvailableGoggles = [];
            _AvailableUniforms = [];
