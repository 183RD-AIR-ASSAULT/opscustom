...
Description:
 ...
 fnc_Arsenal, only the items in the container change.
...
Examples:
 (begin example)
  [this] call fnc_LimitedArsenal;
  [this, "Aegis", 50] call fnc_LimitedArsenal;
  [this, "VANILLA"] call fnc_LimitedArsenal;
  [MyAmmoCrate, "RHS", 0] call fnc_LimitedArsenal;
 (end)
...
call {
 if (_Type isEqualto 0) exitwith {_Type = "};
