class RscNotepad {
    ...
    onLoad = "[""onLoad"",_this,""RscNotepad"",'OP183isplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onUnload = "[""onUnload"",_this,""RscNotepad"",'OP183isplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onMouseButtonDown = "\
