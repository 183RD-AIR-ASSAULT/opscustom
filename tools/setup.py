...
def main():
    ...
    print("""
  ######################################
  # op183 Development Environment Setup #
  ######################################

  This script will create your op183 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your op183 project folder:
    [Arma 3 installation directory]\\{} => op183 project folder
    P:\\{}                              => op183 project folder
